		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Defect Tracker Plus",
									"targetURL": "#comdhenskriptdefecttracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdhenskriptdefecttracker-display": {
								"semanticObject": "comdhenskriptdefecttracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dhenskript.defecttracker",
									"url": sap.ui.require.toUrl("com/dhenskript/defecttracker")
								}
							}
						}
					}
